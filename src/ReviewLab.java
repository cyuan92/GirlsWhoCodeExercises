...
public class ReviewLab {
    ...
    public static boolean isEven(int number) {
    	...
    	// TODO: calculate whether number is even
    	return false;
    }
    ...
    public static double getAverage(ArrayList<Integer> numbers) {
    	...
    	// TODO: get the average of the numbers
    	return -1.0;
    }
    ...
    public static String makeSentence(ArrayList<String> words) {
    	...
    	// TODO: make a sentence with words
    	return null;
    }
    ...
    public static HashMap<Integer, String> createNumberMap()
    {
    	...
    	// TODO: add in the key, value pairs
    ...
    public static String getNumberText(int number)
    {
        ...
        // TODO:  get the text for the number if it exists
     ...
     * Use a "while" loop.
     * 
     * Challenge: Use a recursive function.
     */
